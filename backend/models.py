...
class User(db.Model):
  ...
  albums = db.relationship('Album', cascade="all, delete-orphan", backref='user', lazy=True)
...
class Album(db.Model):
  ...
  artist = db.relationship('User', cascade="all, delete-orphan", backref="album", lazy=True)
...
class Song(db.Model):
  ...
  tot_ratings = db.Column(db.Integer, nullable=False)
  no_ratings = db.Column(db.Integer, nullable=False)
  artist = db.relationship('User', cascade="all, delete-orphan", backref="song", lazy=True)
